...
```{r}
equal_dev_fligner <- readRDS("fligner_p_value.rds")
#start <- proc.time()
#N <- length(formulas)
...
#})
#proc.time()-start
#saveRDS(equal_dev_fligner,"fligner_p_value.rds")
#equal_dev_fligner <- readRDS("fligner_p_value.rds")
...
shapiro_p_value <-readRDS("shapiro_p_value.rds")
```
...
kruskal_p_value <- readRDS("kruskal_p_value.rds")
